...
public class MyFavoritePlaces_alt 
{
	...
	public MyFavoritePlaces_alt(String dataDirectory)
	{
	...
	public void show()
	{
		...
		System.out.println(placeList.get(index)
				.toString());
	...
	public static void main(String[] args) 
	{
		...
		MyFavoritePlaces_alt myFavoritePlaces_alt 
			= new MyFavoritePlaces_alt(dataDirectory);
		
		myFavoritePlaces_alt.interactive();
	}
}
